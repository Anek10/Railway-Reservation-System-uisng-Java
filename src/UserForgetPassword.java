...
public class UserForgetPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCancel.setBounds(319, 446, 194, 40);

        pack();
    }// </editor-fold>//GEN-END:initComponents
    // Button action performed
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        UserLogin ulg = new UserLogin();
        ulg.setVisible(true);
    ...
    private void btnResetPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetPasswordActionPerformed
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/railwaySystem?zeroDateTimeBehavior=convertToNull", "root", "admin"); Statement statement = conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE)) {
            ...
            if (flag != 0) {
                ...
                UserResetPassword rsp;
                rsp = new UserResetPassword();
                rsp.setVisible(true);
                dispose();
            }
